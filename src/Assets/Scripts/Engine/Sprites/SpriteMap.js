...
let SPRITECOLORMATRIX = {}
let SPRITES_1 = {}
let SPRITES_2 = {}
export default class SpriteMap{
    static getSPRITECOLORMATRIX(){
    }
    static init(){
        SpriteMap.SPRITECOLORMATRIX = {
        ...
        SPRITECOLORMATRIX = SpriteMap.SPRITECOLORMATRIX;
        SpriteMap.SPRITES_1 = {
        ...
        SPRITES_2 = SpriteMap.SPRITES_2;
    }
}
export {SpriteMap,SPRITECOLORMATRIX,SPRITES_1,SPRITES_2};
