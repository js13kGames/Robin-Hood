export default class KeyboardAndMouse{ 
    ...
    init(target,eventManager,eventListeners,eventOnLunch = false){
...
KeyboardAndMouse.Event = {
    ...
    MOUSEUP     : 'mouseup',        //MOUSE LEFT PRESSED
    ...
    MOUSE : ['mousedown','mouseup','mousemove','wheel','contextmenu'],
    ALL : ['keydown','keyup','keypress',
